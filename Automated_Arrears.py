...
try:
    ...
    u = 'https://outlook.office.com/webhook/6d877f97-acbe-4278-9581-b187845375fa@2a7dc11b-8fbf-481e-8388-d4ca3030007d/IncomingWebhook/89679eec8b6b41a980fd6579816b065a/52e2a5b3-5b05-44e8-9d31-740208a972cb'
    m = {
        "@type": "MessageCard",
        "@context": "http://schema.org/extensions",
        "themeColor": "e93cac",
        "summary": "Arrears Error Notification",
        "sections": [{
            'title': "Arrears Error",
            'facts': [{
                'name': "Date and Time",
    ...
    w = requests.post(url=u, headers=h, json=m)
    input("Error has been raised and sent to Teams!")
